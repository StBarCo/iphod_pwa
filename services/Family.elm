...
| Toggle
    tag: about_family_prayer
    label: BLANK
    --
    selected: False
    tag: show_about_family_prayer
    label: Concerning Family Prayer
    text:
    These devotions follow the basic structure of the Daily Office
    of the Church and are particularly appropriate for families with
    young children.

    The Reading and the Collect may be read by one person, and the
    other parts said in unison, or in some other convenient manner.
    Appropriate Opening Sentences, Psalms, Readings, and Collects
    ...
    some other manual of devotion which provides daily selections
    for the Church Year.
    
    A concluding sentence from Morning or Evening Prayer may be
...
| Options
    tag: fpmp_psalm
    label: Psalm 51:10-1, alternately Psalm 5:1-3
    --
    selected: True
    tag: fpmp_ps51
    label: Psalm 52
...
| Toggle
    tag: fpmp_apostles_creed
    label: The Apostles' Creed may be said
    --
    selected: False
    tag: select_apostles_creed
...
| Options
    tag: fpmp_lords_prayer
    label: Lord's Prayer
    --
    selected: True
    tag: fpmp_lords_prayer_traditional
    label: Traditional
    text:
...
| Options
    tag: fpmidday_lords_prayer
    label: Lord's Prayer
    --
    selected: True
    tag: fpmidday_lords_prayer_traditional
    label: Traditional
    text:
    Our Father, who art in heaven
        hallowed be thy Name,
    ...
    selected: False
    tag: fpmidday_lords_prayer_modern
    label: Modern
    text:
    Our Father in heaven,
        hallowed be your Name,
...
| Rubric
    A hymn or canticle may be used; the Apostles’ Creed (page 75) may be said.
    Prayers may be offered for ourselves and others.

| Options
    tag: fpee_lords_prayer
    label: Lord's Prayer
    --
    selected: True
    tag: fpee_lords_prayer_traditional
    label: Traditional
    text:
    Our Father, who art in heaven
        hallowed be thy Name,
...
| Rubric
    Prayers may be offered for ourselves and others. It is appropriate that prayers of
...
| Plain
    Almighty God, we entrust all who are dear to us to your neverfailing care and love, 
    for this life and the life to come, knowing
...
| CollectTitle
    family responses before meals /Traditional/
...
| Plain
    In Advent, using the Antiphons found in the Calendar of Holy Days and
